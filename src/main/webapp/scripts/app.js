...
var octopusApp = angular.module('octopusApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'octopusAppUtils', 'pascalprecht.translate', 'truncate']);
